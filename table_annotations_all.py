...
def main():
    ...
    samer_dir = (
        "/projectnb/npbssmic/ac25/Myelin_paper_CCP_dataset_samer/1st_batch_annotations"
    )
    dl_dir = "/projectnb/npbssmic/s/Anna_DL/test/Defect-Detection-main/data/inference/CCPtune/1st_batch"

    save_path = (
        "/projectnb/npbssmic/ac25/Myelin_paper_final/defect_counts_raw_1st_batch.xlsx"
    )
